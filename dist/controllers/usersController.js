    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, user.update(body)];
            case 4:
                _a.sent();
                res.json(user);
                _a.label = 5;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, user.destroy()];
            case 4:
                _a.sent();
                res.status(200).json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, user.update({ estatus: !user.estatus })];
            case 4:
                _a.sent();
                res.json(user);
                _a.label = 5;
